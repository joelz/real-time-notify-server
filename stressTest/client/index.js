...
var argParser = optimist
    .usage("Usage: $0 -c [num]")
    .describe("c", "Numbern of clients to spawn")
    .alias("c", "clients")
    .default("c", 10)
...
var handlers = {
    connect: function() {
        ...
        // Defer attaching the "update" handler to ensure that all clients
        ...
        if (!this.hasConnected) {
            ...
            setTimeout(function() {
                this.on("update", handlers.update);
            }.bind(this), 1000);
        }
